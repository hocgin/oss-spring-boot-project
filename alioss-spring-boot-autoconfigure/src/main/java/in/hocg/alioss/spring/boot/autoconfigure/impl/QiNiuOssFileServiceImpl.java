...
public class QiNiuOssFileService implements OssFileService {
    @Getter
    ...
    public String upload(File file, String filename) {
        return this.upload(file, filename, getBucket());
    }
    ...
    private String getFileUrl(String key) {
        return URLUtil.completeUrl(getDomain(), key);
    }

    private String getUploadToken(String bucket) {
        return Auth.create(getAccessKey(), getSecretKey()).uploadToken(bucket);
    }
}
